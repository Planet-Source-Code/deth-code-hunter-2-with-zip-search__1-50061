...
'this module implements zip file capabilities with Unzip32.dll.
'i found this on psc somewhere, needs some work but i dont have time
...
On Error GoTo vbErrorHandler
    ...
    VBUnzip = Wiz_SingleEntryUnzip(0, uZipNames, 0, uExcludeNames, UZDCL, UZUSER)

Exit Function
vbErrorHandler:
    Err.Raise Err.Number, "modCode::VBUnzip", Err.Description
